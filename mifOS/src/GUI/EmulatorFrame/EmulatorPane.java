...
public class EmulatorPane extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        procesai = new javax.swing.JTextArea();

        setBorder(null);
        setPreferredSize(new java.awt.Dimension(1248, 525));
        ...
        console.setFont(new java.awt.Font("DejaVu Sans Mono", 0, 12));
        console.setRows(40);
        ...
        procesai.setColumns(20);
        procesai.setRows(5);
        jScrollPane1.setViewportView(procesai);
    ...
    private javax.swing.JTextArea procesai;
	...
	public void setRegisterValue(Register register, int value) {
		switch (register) {
			case R:
				this.registerRValue.setText(MachineDataUtilities.formatData(value, 8));
				this.registerRValueR.setText(MachineDataUtilities.formatData(value, 8));
				break;

			case M:
				this.registerMValue.setText(MachineDataUtilities.formatData(value, 8));
				this.registerMValueR.setText(MachineDataUtilities.formatData(value, 8));
				break;

			case IC:
				this.registerICValue.setText(MachineDataUtilities.formatData(value, 4));
				this.registerICValueR.setText(MachineDataUtilities.formatData(value, 4));
				break;

			case S:
				this.registerSValue.setText(MachineDataUtilities.formatData(value, 8));
				this.registerSValueR.setText(MachineDataUtilities.formatData(value, 8));
				break;

			case SF:
				this.registerSFValue.setText(MachineDataUtilities.formatData(value, 8));
				this.registerSFValueR.setText(MachineDataUtilities.formatData(value, 8));
				break;

			case SF_1:
				this.registerSFValue_1.setText(MachineDataUtilities.formatData(value, 2));
				break;

			case SF_2:
				this.registerSFValue_2.setText(MachineDataUtilities.formatData(value, 2));
				break;

			case SF_3:
				this.registerSFValue_3.setText(MachineDataUtilities.formatData(value, 2));
				break;

			case SF_4:
				this.registerSFValue_4.setText(MachineDataUtilities.formatData(value, 2));
				break;

			case MODE:
				this.registerMODEValue.setText(MachineDataUtilities.formatData(value, 1));
				break;

			case PD:
				this.registerPDValue.setText(MachineDataUtilities.formatData(value, 8));
				break;

			case PTR:
				this.registerPTRValue.setText(MachineDataUtilities.formatData(value, 8));
				break;

			case CHST1:
				this.registerCHST1Value.setText(MachineDataUtilities.formatData(value, 1));
				break;

			case CHST2:
				this.registerCHST2Value.setText(MachineDataUtilities.formatData(value, 1));
				break;

			case CHST3:
				this.registerCHST3Value.setText(MachineDataUtilities.formatData(value, 1));
				break;
		}
	}
	...
	public void setMemoryTableModelValue(int aValue, int rowIndex,
		...
		this.memoryTableModel.setValueAt(MachineDataUtilities.formatData(aValue, digitCount),
	 ...
	 */
	public void setMemoryTableModelValue(String command, int rowIndex, int columnIndex) {
		this.memoryTableModel.setValueAt(command, rowIndex, columnIndex);
	}
	
	public void setP(String text) {
		this.procesai.setText(text);
	}
}
