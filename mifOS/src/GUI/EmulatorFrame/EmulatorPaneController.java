...
public class EmulatorPaneController {
	...
	private void addListeners() {
		this.emulatorFrame.getMainPane().
				getLoadProgram().addActionListener(new LoadProgramButtonActionListener());

		this.emulatorFrame.getMainPane().
				getExecuteProgram().addActionListener(new ExecuteProgramButtonActionListener());

		this.emulatorFrame.getMainPane().
				getExecuteByStep().addActionListener(new ExecuteProgramByStepButtonActionListener());

		this.emulatorFrame.getMainPane().
				getShowVMMemoryButton().addActionListener(new ShowVMMemoryButtonListener());
	...
	class LoadProgramButtonActionListener implements ActionListener {
		...
		public void actionPerformed(ActionEvent ae) {
			int option = EmulatorPaneController.this.emulatorFrame.getMainPane().getFileChooser().
			...
			if (option == JFileChooser.APPROVE_OPTION) {
				if (EmulatorPaneController.this.emulatorFrame.getHeight() > 545) {
					...
					file = EmulatorPaneController.this.emulatorFrame.getMainPane().getFileChooser().
							getSelectedFile();
				}
	...
	class RMListener implements RMEventListener {
		...
		public void inputRequested() {
			...
			EmulatorPaneController.this.emulatorFrame.getMainPane().setRegisterValue(Register.CHST1, chst1);

			EmulatorPaneController.this.emulatorFrame.getMainPane().setInputEditableStatus(true);
		}

		public void outputRequested() {
			int chst2 = EmulatorPaneController.this.machine.getRegister().chm1;
			EmulatorPaneController.this.emulatorFrame.getMainPane().setRegisterValue(Register.CHST2, chst2);
		...
		public void stepRequested() {
			...
			//------SF pabaiciui
			int sf_1 =
					EmulatorPaneController.this.machine.getRegister().sf % 0x100;

			int sf_2 =
					EmulatorPaneController.this.machine.getRegister().sf % 0x10000;
			sf_2 = sf_2 / 0x100;
			...
			int sf_4 =
					EmulatorPaneController.this.machine.getRegister().sf / 0x1000000;
			...
			if ((mode == 0) && (EmulatorPaneController.this.executingType == 0)) {
				EmulatorPaneController.this.emulatorFrame.getMainPane().setShowVMMemoryButtonState(true);
			} else {
				EmulatorPaneController.this.emulatorFrame.getMainPane().setShowVMMemoryButtonState(false);
			}

			EmulatorPaneController.this.emulatorFrame.getMainPane().setRegisterValue(Register.R, r);

			EmulatorPaneController.this.emulatorFrame.getMainPane().setRegisterValue(Register.M, m);

			EmulatorPaneController.this.emulatorFrame.getMainPane().setRegisterValue(Register.IC, ic);

			EmulatorPaneController.this.emulatorFrame.getMainPane().setRegisterValue(Register.SF, sf);

			EmulatorPaneController.this.emulatorFrame.getMainPane().setRegisterValue(Register.S, s);

			EmulatorPaneController.this.emulatorFrame.getMainPane().setRegisterValue(Register.MODE, mode);

			EmulatorPaneController.this.emulatorFrame.getMainPane().setRegisterValue(Register.PTR, ptr);

			EmulatorPaneController.this.emulatorFrame.getMainPane().setRegisterValue(Register.PD, pd);

			EmulatorPaneController.this.emulatorFrame.getMainPane().setRegisterValue(Register.SF_1, sf_1);

			EmulatorPaneController.this.emulatorFrame.getMainPane().setRegisterValue(Register.SF_2, sf_2);

			EmulatorPaneController.this.emulatorFrame.getMainPane().setRegisterValue(Register.SF_3, sf_3);

			EmulatorPaneController.this.emulatorFrame.getMainPane().setRegisterValue(Register.SF_4, sf_4);

			EmulatorPaneController.this.emulatorFrame.getMainPane().setRegisterValue(Register.CHST1, chst1);

			EmulatorPaneController.this.emulatorFrame.getMainPane().setRegisterValue(Register.CHST2, chst2);

			EmulatorPaneController.this.emulatorFrame.getMainPane().setRegisterValue(Register.CHST3, chst3);
			...
			if (ptr == 0) {
				...
				int[] interuptArea = {pd, pd + 7};

				//System.out.printf("PD: %x %x\n", interuptArea[0], interuptArea[1]);
	...
	class ChannelInputDevice implements KeyListener {
		...
		private void endInput() {
			...
			EmulatorPaneController.this.emulatorFrame.getMainPane().setInputText("");
			EmulatorPaneController.this.emulatorFrame.getMainPane().setInputEditableStatus(false);
	...
	private void setRealMemoryValues() {
		...
		for (int index = 0x0; index < 0xFFFF; index++) {
			EmulatorPaneController.this.emulatorFrame.getMainPane().setMemoryTableModelValue(memoryDump[index], index, 2, 8);
		}
	}
	...
	private void parseCommands() {
		...
		for (int index = 0x10; index < 0xFFF; index++) {
			...
			EmulatorPaneController.this.emulatorFrame.getMainPane().setMemoryTableModelValue(command, index, 3);
		}
	}
	...
	private void setVirtualMemoryAddress() {
		...
		int[] interuptArea = {this.machine.getRegister().pd, this.machine.getRegister().pd + 7};
